...
export const GOALS = [
    ...
    {
        question: `Preamble`,
        answer: `I would say that my goals are quite related to my day-to-day responsibilities at work. About a quarter of the way through the workterm, the company hired a new CTO and quickly shifted to becoming much more AI focused in all aspects of development. So my first goal is highly related to the reality of my work. My second goal is about learning more about concepts in the payment domain. Being on the payment squad I thought this was a great goal, not only to understand things more while working, but because I'm actually interested in learning about this area. Seeing a pin pad in a TV show or real life and being able to say "I've worked with that!" is pretty cool.  `,
    },
    {
        question: `Reflection`,
        answer: `[ Honestly reflect on each goal. Which did you achieve? Which fell short? What factors helped or hindered your progress? ]`,
    },
];
